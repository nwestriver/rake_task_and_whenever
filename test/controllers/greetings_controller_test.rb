...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create greeting" do
    assert_difference("Greeting.count") do
      post greetings_url, params: { greeting: { body: @greeting.body, published_at: @greeting.published_at, status: @greeting.status, title: @greeting.title } }
    end
  ...
  test "should update greeting" do
    patch greeting_url(@greeting), params: { greeting: { body: @greeting.body, published_at: @greeting.published_at, status: @greeting.status, title: @greeting.title } }
